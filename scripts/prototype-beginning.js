...
//the problem with this approche that let's say we're building a game and each objector each player will have planty of methods so will 
//get for a lot of memory stockage for each player and we have tons of players and ennemies
...
//HOW? javascript giving us Object.create() which is a method that allows us make a look and try to find if the property in the object that 
...
//each function has a property called protoype which point to an empty object so we can use this objext in the function contructor also constorctur is 
//term to a function that consturct an object we call it constructor ,to append any value to this prototype and it will be shared with all instances because we point to it via Object.create(functionName.prototype) or new keyword will do that automatcly behind the scenes
//javascrippt giving us in our toolsbox a keyword Call 🧐'new' what that keyword do for us
//simple its create an empty object == this   and point to the prototype of the function 
//like explain above and return the this object
...
//javascript community made new simple way to use function constructor the which is just a syntatic sugar like 
//they said they not changing what under the hood javascript do like we went step by step to make
//a function constructor this feature called 'class' so if you have a different background from java or c++ you will
//be familaire with the class consturctor let's how this look likes
...
///And Done yeah class is more convient way to construct an object and encapsulate all your
//method in your class consturct , and it's every good to know that
